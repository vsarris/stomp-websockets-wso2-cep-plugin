...
/*
public class Stomp_receiverTestCase extends CEPIntegrationTest {
    private static final Log log = LogFactory.getLog(Stomp_receiverTestCase.class);
    ...
    @Test(groups = {"wso2.cep"}, description = "Testing sstomp_receiver receiver ")
